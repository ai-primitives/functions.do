...
describe('generateObject', () => {
  ...
  it(
    'should generate an object based on a simple schema',
    async () => {
  ...
  it(
    'should generate an object based on a complex nested schema',
    async () => {
  ...
  it(
    'should generate content without a schema',
    async () => {
      const result = await generateObject({
  ...
  it(
    'should handle enum values in the schema',
    async () => {
  ...
  it(
    'should support calls without a schema',
    async () => {
      const result = await generateObject({
  ...
  it(
    'should be able to search the web',
    async () => {
      const result = await generateObject({
